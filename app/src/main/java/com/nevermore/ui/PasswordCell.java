...
public class PasswordCell extends RelativeLayout {
    ...
    public PasswordCell(Context context) {
        this(context, null);
    }

    public PasswordCell(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PasswordCell(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;
    }


    public void initStyle(int bgdrawable, int pwdlength, float splilinewidth,  int pwdcolor, int pwdsize)
    {
        this.pwdlength = pwdlength;
        initEdit(bgdrawable);
        initShowInput(bgdrawable, pwdlength,  pwdcolor, pwdsize,splilinewidth);
    }
     ...
     */
    public void initShowInput(int resCellBg, int pwdlength,  int pwdcolor, int pwdsize,float padding)
    {
        //添加密码框父布局
...
//        linearLayout.setBackgroundResource(bgcolor);
        ...
        LinearLayout.LayoutParams params2 = new LinearLayout.LayoutParams(dip2px(context, padding),LayoutParams.MATCH_PARENT);
        for(int i = 0; i < textViews.length; i++)
        {
            ...
            textViews[i].setBackgroundResource(resCellBg);
